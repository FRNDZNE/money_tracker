...
const submit = () => {
    form.patch(route('savings-goals.update', props.goal.id));
};
</script>
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-xl font-bold text-slate-900">Edit Savings Goal</h1>
                    <p class="text-sm text-slate-500 mt-0.5">Update your financial target</p>
                </div>
            </div>
        </template>
