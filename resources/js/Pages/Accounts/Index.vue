                ...
                <table class="w-full text-sm">
                    <thead>
                        <tr class="bg-slate-50 border-b border-slate-200">
                            ...
                            <th class="text-right px-6 py-3.5 text-xs font-semibold text-slate-500 uppercase tracking-wide">Initial Balance</th>
                            <th class="text-right px-6 py-3.5 text-xs font-semibold text-slate-500 uppercase tracking-wide">Current Balance</th>
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        >
                            ...
                            <td class="px-6 py-4 text-right text-slate-600">{{ formatCurrency(account.initial_balance) }}</td>
